...
model PulseDisturbance "瞬时脉冲扰动"
  parameter Real pulseForce = 0.08 "脉冲扰动力";
  parameter Modelica.Units.SI.Time startTime = 18 "脉冲开始时间";
  parameter Modelica.Units.SI.Time pulseDuration = 0.4 "脉冲持续时间";
