...
model InertiaPerturbation "Inertia perturbation experiment"
  extends Modelica.Icons.Example;

  parameter Real inertiaScale = 1.5 "Body inertia perturbation scale";

  Modelica.Blocks.Sources.Step xCommand(offset = 0, height = 2, startTime = 15) 
  ...
  QuadrotorModel.Mechanics.QuadChassis quadChassisTest17_1(
    bodyI11 = 0.00010556 * inertiaScale,
    bodyI22 = 0.00010556 * inertiaScale,
    bodyI33 = 0.00010556 * inertiaScale) 
