...
model PulseDisturbanceExperiment "Pulse disturbance experiment"
  ...
  QuadrotorModel.Disturbances.PulseDisturbance disturbance(pulseForce = 0.08, startTime = 18, pulseDuration = 0.4) 
...
end PulseDisturbanceExperiment;