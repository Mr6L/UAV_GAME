...
model StepResponseYaw "Yaw角阶跃响应"
  extends Modelica.Icons.Example;

  Modelica.Blocks.Sources.Step yawCommand(offset = 0, height = 0.17453292519943295, startTime = 15) 
    annotation (Placement(transformation(origin={-168,32},
extent={{-10,-10},{10,10}})));
...
equation
  connect(yawCommand.y, controller3_2.yaw_command) 
