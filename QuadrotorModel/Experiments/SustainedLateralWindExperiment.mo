...
model SustainedLateralWindExperiment "持续横向风扰实验"
  extends StepResponseZ;

  QuadrotorModel.Disturbances.SustainedLateralWind disturbance(
    lateralForce = 0.03,
    startTime = 12) 
  ...
  annotation(experiment(Algorithm=Dassl,InlineIntegrator=false,InlineStepSize=false,NumberOfIntervals=500,StartTime=0,StopTime=50,StoreEventValue=0,Tolerance=0.0001),__MWORKS(ContinueSimConfig(SaveContinueFile="false",SaveBeforeStop="false",NumberBeforeStop=1,FixedContinueInterval="false",ContinueIntervalLength=50,ContinueTimeVector)));
