...
model SustainedLateralWindExperiment "Sustained lateral wind disturbance experiment"
  ...
  QuadrotorModel.Disturbances.SustainedLateralWind disturbance(lateralForce = 0.03, startTime = 12)
...
equation
  ...
  connect(sensors1_1.PosMea, controller3_2.position)
    annotation (Line(points = {{-19, -71.7}, {-126, -71.7}, {-126, 10}, {-99, 10}}, color = {0, 0, 127}, thickness = 0.8));
  ...
  connect(disturbance.force, disturbanceForce.force)
    annotation (Line(points = {{-132, -82}, {20, -82}, {20, -86}, {46, -86}}, color = {0, 0, 127}, thickness = 0.8));
  connect(disturbanceForce.frame_b, quadChassisTest17_1.frame_a)
    annotation (Line(points = {{68, -86}, {150, -86}, {150, 8.5}, {120, 8.5}}, color = {95, 95, 95}, thickness = 0.8));
...
end SustainedLateralWindExperiment;
