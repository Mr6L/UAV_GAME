within QuadrotorModel.Experiments;
      model YawCommandController "带外部yaw指令输入的实验控制器"
        ...
        Modelica.Blocks.Math.Feedback feedback 
          annotation (Placement(transformation(origin = {-40.0, 136.0},
            extent = {{-10.0, -10.0}, {10.0, 10.0}})));
        QuadrotorModel.Blocks.ControlMethod.PID PID1(KP = 5, KI = 0, KD = 0) annotation (Placement(transformation(origin = {-10.000000000000004, 136.24557864041074},
          extent = {{-10.0, -10.0}, {10.0, 10.0}})));

        Modelica.Blocks.Math.Feedback feedback1 
          annotation (Placement(transformation(origin = {-40.0, 51.9297463276959},
            extent = {{-10.0, -10.0}, {10.0, 10.0}})));
        QuadrotorModel.Blocks.ControlMethod.PID PID5(KP = 14.142, KI = 0, KD = 1.414) annotation (Placement(transformation(origin = {-9.999999999999998, 51.929746327695895},
          extent = {{-10.0, -10.0}, {10.0, 10.0}})));

        Modelica.Blocks.Math.Feedback feedback2 
          annotation (Placement(transformation(origin = {-39.99999999999999, -41.737719741257976},
            extent = {{-10.0, -10.0}, {10.0, 10.0}})));
        QuadrotorModel.Blocks.ControlMethod.PID PID6(KP = 14.142, KI = 0, KD = 1.414) annotation (Placement(transformation(origin = {-10.0, -41.737719741257976},
          extent = {{-10.0, -10.0}, {10.0, 10.0}})));

        Modelica.Blocks.Math.Feedback feedback3 
          annotation (Placement(transformation(origin = {-177.0338684599124, -144.95408039247764},
            extent = {{-10.0, -10.0}, {10.0, 10.0}})));
        QuadrotorModel.Blocks.ControlMethod.PID PID7(KP = 8, KI = 6, KD = 4) annotation (Placement(transformation(origin = {-147.6231252910071, -145.3480005256226},
          extent = {{-10.0, -10.0}, {10.0, 10.0}})));
        ...
        Modelica.Blocks.Math.Gain gain3(k = 1) 
          annotation (Placement(transformation(origin = {-112.51509596744064, -144.65059206492597},
            ...
            rotation = -180.0)));
        QuadrotorModel.Blocks.ControlMethod.PID PID3(KP = 1.5, KI = 0, KD = 1) annotation (Placement(transformation(origin = {-147.89106799143525, 54.13037202945324},
          extent = {{-10.0, -10.0}, {10.0, 10.0}})));

        QuadrotorModel.Blocks.ControlMethod.PID PID4(KP = 1.5, KI = 0, KD = 1) annotation (Placement(transformation(origin = {-147.6231252910071, -42.78744987823214},
          extent = {{-10.0, -10.0}, {10.0, 10.0}})));
        ...
        Modelica.Blocks.Nonlinear.Limiter limiter5(uMax = 7) 
          annotation (Placement(transformation(origin = {19.999999999999996, 136.0},
            extent = {{-10.0, -10.0}, {10.0, 10.0}})));
        Modelica.Blocks.Sources.Constant xReference(k = 0) 
          annotation (Placement(transformation(origin = {-226.0, 94.0},
            extent = {{-10.0, -10.0}, {10.0, 10.0}})));
        Modelica.Blocks.Sources.Constant yReference(k = 0) 
          annotation (Placement(transformation(origin = {-226.0, 44.0},
            extent = {{-10.0, -10.0}, {10.0, 10.0}})));
        Modelica.Blocks.Sources.Ramp zReference(
          offset = 0,
          height = 5,
          startTime = 0,
          duration = 5) 
        ...
        Modelica.Blocks.Interfaces.RealOutput y3
          "四号电机转速控制信号" annotation (Placement(transformation(origin = {280.0, -144.0},
            ...
            iconTransformation(origin = {110.0, -58.0},
              extent = {{-10.0, -10.0}, {10.0, 10.0}})));
        Modelica.Blocks.Interfaces.RealInput yaw_command "Yaw angle command" 
      ...
      equation
        ...
        connect(feedback.u1, yaw_command) 
          annotation (Line(origin = {-53.0, 136.0},
            ...
            color = {0, 0, 127}));
        connect(xReference.y, feedback4.u1) 
          annotation (Line(origin = {-234.0, 75.0},
            points = {{19.0, 19.0}, {28.0, 19.0}, {28.0, -20.0}, {52.0, -20.0}},
            color = {0, 0, 127}));
        connect(yReference.y, feedback5.u1) 
          annotation (Line(origin = {-235.0, 26.0},
            points = {{20.0, 18.0}, {30.0, 18.0}, {30.0, -69.0}, {51.0, -69.0}},
            color = {0, 0, 127}));
        connect(zReference.y, feedback3.u1) 
          annotation (Line(origin = {-235.0, -27.0},
            points = {{20.0, -67.0}, {30.0, -67.0}, {30.0, -118.0}, {50.0, -118.0}},
            color = {0, 0, 127}));
      end YawCommandController;