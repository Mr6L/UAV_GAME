...
equation
  for i in 1:n loop
    rawOffsets[i, 1] =
      ...
      else if formationType == 2 then 
        (if i == 1 then 0 else if i == 2 then -spacing else if i == 3 then -spacing else if i == 4 then -2 * spacing else -spacing) 
      else if formationType == 3 then 
        (if i == 1 then 0 else if i <= 3 then -spacing else -2 * spacing) 
      else 
        -(i - 1) * spacing;

    rawOffsets[i, 2] =
      if formationType == 1 then 
        (if i == 1 then 0 else if i == 2 then -spacing else spacing) 
      else if formationType == 2 then 
        (if i == 1 then 0 else if i == 2 then -spacing else if i == 3 then spacing else if i == 4 then 0 else 0) 
      else if formationType == 3 then 
        (if i == 1 then 0 else if i == 2 then -0.75 * spacing else if i == 3 then 0.75 * spacing else if i == 4 then -1.5 * spacing else 1.5 * spacing) 
      else 
        0;
  ...
  annotation (
    Icon(coordinateSystem(extent = {{-100, -100}, {100, 100}}),
      graphics = {Rectangle(extent = {{-100, 100}, {100, -100}}, radius = 20,
        ...
        textString = "Offsets")}),__MWORKS(version="26.2.1"));
